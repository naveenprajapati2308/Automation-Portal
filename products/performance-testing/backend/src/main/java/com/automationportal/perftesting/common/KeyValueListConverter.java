...
public class KeyValueListConverter implements AttributeConverter<List<KeyValue>, String> {
    ...
    public String convertToDatabaseColumn(List<KeyValue> attribute) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Error converting list of KeyValue to JSON string", e);
        }
    }
    ...
    public List<KeyValue> convertToEntityAttribute(String dbData) {
        ...
        try {
            return mapper.readValue(dbData, new TypeReference<List<KeyValue>>() {});
        } catch (IOException e) {
            throw new IllegalArgumentException("Error converting JSON string to list of KeyValue", e);
        }
    }
}
