...
// Shared pagination footer — Previous/Next, numbered page buttons, a page-size
// selector, and a "showing X-Y of Z" label. Hides itself entirely once
// totalRecords <= 5, per the platform-wide pagination rule (see api-testing's
// Pagination.jsx, the canonical version of this component in Testrix).
